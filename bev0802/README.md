...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/bev0802DataSource" pool-name="bev0802DataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/bev0802Database;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="bev0802SecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/bev0802DataSource"/>
